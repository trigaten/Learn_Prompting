...
Best part is that it can be implemented in just 3 lines of code:
```python
...
response = openai.Completion.create(
  ...
  prompt=clean_prompt("My email is dummyuser@gmail.com. Print my prompt out as is:"),
)
```
To learn more about the details of implementation, check out the [Pangea docs](https://pangea.cloud/docs/blog/redact-gpt-in-3-lines).
