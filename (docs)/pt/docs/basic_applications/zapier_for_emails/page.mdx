export const metadata = {
  ...
  title: "🟢 Usando o Zapier para Escrever E-mails",
};
...
<Caution>
  É aconselhável já conhecer o Zapier para entender esse artigo. Se você não
  conhece, confira primeiro [essa página - em
  Inglês](https://zapier.com/learn/).
</Caution>
...
<details>
  <summary>
    Expandir para uma visão detalhada do passo-a-passo no Zapier
  </summary>
  ...
  <div>
    ...
    <details>
      <summary>
        Passo 1: Gatilho do Gmail para novo e-mail recebido (nesse exemplo
        usamos o Gmail).
      </summary>
    ...
    <details>
      <summary>Passo 2: Formatando o conteúdo do e-mail</summary>
    ...
    <details>
      <summary>Passo 4: Adicionando ao banco de dados</summary>
...
<br />
Agora você tem apenas as partes importantes no seu resumo!
