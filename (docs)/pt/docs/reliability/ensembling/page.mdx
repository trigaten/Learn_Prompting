export const metadata = {
  sidebar_position: 5,
  title: "🟡 Montagem de prompts / Métodos de ensamblagem",
};
...
A ideia por trás disso é criar diferentes _visões_ da tarefa. Então, aplicamos cada uma ao contexto dado da seguinte forma:
...
Estas são _respostas intermediárias_. Precisamos mapeá-las para etiquetas de tarefa (por exemplo, Sim ou Não).
