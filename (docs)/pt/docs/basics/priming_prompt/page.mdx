export const metadata = { sidebar_position: 95, title: "🟢 Priming Chatbots" };

# 🟢 Priming Chatbots

<Takeaways>- Control the style and structure of a conversation</Takeaways>
