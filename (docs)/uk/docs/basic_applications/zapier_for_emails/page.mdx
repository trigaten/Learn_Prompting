export const metadata = {
  ...
  title: "🟢 Електронні листи в Zapier",
};
...
<Caution>
  Для цієї статті корисно ознайомитися із Zapier. Якщо ви ще цього не зробили,
  то можете переглянути цю [статтю](https://zapier.com/learn/).
</Caution>
...
1. Надішліть до GPT-3 для створення резюме
1. Зберігайте результати в базі даних
...
Ось налаштування в Zapier, яке дозволяє створити короткий зміст, як показано на схемі.
Він має обмеження, але справляється зі своєю роботою та може створити корисну базу
даних.
...
<br />
Тепер у вас залишилися лише найважливіші частини короткого викладу листів!
