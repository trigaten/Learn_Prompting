export const metadata = { sidebar_position: 1000, title: "🟢 Введення коду" };
...
<Note>
  З того часу MathGPT захищено від введення коду. Будь ласка, не намагайтеся
  зламати її; виклики API платні.
</Note>
