export const metadata = {
  sidebar_position: 2,
  title: "🟡 LLMs Utilizando Herramientas",
};
...
<pre>
  ...
  <span className="bluegreen-highlight">
    El precio actual es BASE DE DATOS [SELECCIONAR precio DE acciones DONDE
    empresa = "Apple" Y tiempo = "ahora"].
  </span>
</pre>
...
<div style={{ textAlign: "center" }}>Ejemplo de Sistema MRKL (AI21)</div>
