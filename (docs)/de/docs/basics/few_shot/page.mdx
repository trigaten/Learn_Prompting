...
Eine weitere Prompting-Strategie ist das _Few Shot Prompting_(@logan-iv-etal-2022-cutting)(@lake2015human), bei dem es im Grunde nur darum geht, dem Modell einige Beispiele (sogenannte Shots) für das zu zeigen, was es tun soll.
...
<Notice>Jedes Eingabe-Ausgabe-Paar wird als *Exemplar* bezeichnet.</Notice>
...
<Notice>
  Obwohl du dieselbe Ausgabe auch mit einem Befehlsprompt erzeugen könntest, ist
  die Ausgabe mit dem Few Shot Prompt viel *konsistenter*.
</Notice>
