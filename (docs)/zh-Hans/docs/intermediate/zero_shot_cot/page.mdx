export const metadata = { sidebar_position: 4, title: "🟢 零样本思维链" };
...
<div style={{ textAlign: "center" }}>零样本思维链(Kojima et al.)</div>
...
<div style={{ textAlign: "center" }}>完整的零样本思维链过程(Kojima et al.)</div>
