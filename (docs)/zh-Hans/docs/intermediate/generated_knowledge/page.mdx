export const metadata = { sidebar_position: 7, title: "🟡 知识生成" };
...
<div style={{ textAlign: "center" }}>知识生成(Liu et al.)</div>
...
<div style={{ textAlign: "center" }}>生成的知识示例(Liu et al.)</div>

## 知识集成

接下来，我们生成“知识增强”问题，并用它们提示 %%LLM|LLM%% 获得最终答案。最好的理解方法是通过一个例子来说明。

假设我们正在尝试回答**问题**“大多数袋鼠有
{"<mask\>"}
肢体”。假设在知识生成步骤中，我们生成了 2 个知识（M=2）：
