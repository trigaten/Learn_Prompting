export const metadata = { sidebar_position: 50, title: "🟢 給予指令" };
...
<Takeaways>- 理解指令提示 - 了解指令提示的複雜應用</Takeaways>
...
<br />
嘗試變更姓名，直到找到提示無法正確處理的姓名。如果你能做到這一點，也許你也能提升提示能力！這是一個有趣的練習，可以提高您的提示工程技能！
