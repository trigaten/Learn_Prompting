export const metadata = { sidebar_position: 90, title: "🟢 Kelemahan LLM" };
...
<Note>
  Strategi seperti LLM yang diperkuat oleh pencarian (LLM yang dapat mencari
  Internet dan sumber lainnya) sering dapat memperbaiki masalah ini
</Note>
