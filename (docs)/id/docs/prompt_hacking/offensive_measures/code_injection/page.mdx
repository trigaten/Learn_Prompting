export const metadata = { sidebar_position: 1000, title: "🟢 Injeksi Kode" };
...
<Note>
  MathGPT sejak itu telah diamankan dari injeksi kode. Tolong jangan mencoba
  untuk meretasnya; mereka membayar untuk panggilan API.
</Note>
