export const metadata = { sidebar_position: 2, title: "🟢 Prompt Leaking" };

# 🟢 Prompt Leaking

Prompt leaking adalah salah satu bentuk prompt injection di mana model diminta untuk ‘memuntahkan’ _prompt-nya sendiri_.
