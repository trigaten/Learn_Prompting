export const metadata = { sidebar_position: 5, title: "🟡 Prompt Ensembling" };
...
Ide di balik hal ini adalah untuk membuat berbagai _tampilan_ dari tugas tersebut. Kemudian kami menerapkan masing-masing ke konteks yang diberikan seperti ini:
...
Ini adalah _jawaban_ tingkat menengah. Kita perlu memetakan mereka ke label tugas (misalnya Ya atau Tidak).
