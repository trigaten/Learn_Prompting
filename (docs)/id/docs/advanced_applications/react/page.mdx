export const metadata = {
  sidebar_position: 3,
  title: "🟡 LLM yang Melakukan Penalaran dan Aksi (Reason and Act)",
};
...
<div style={{ textAlign: "center" }}>Sistem ReAct (Yao et al.)</div>
...
<div style={{ textAlign: "center" }}>Hasil ReAct (Yao et al.)</div>
