...
<Caution>
  اس مضمون کے لیے Zapier کو پہلے سے جاننا مفید ہے۔ اگر آپ ایسا نہیں کرتے ہیں تو
  آپ اس [آرٹیکل](https://zapier.com/learn/) کو دیکھ سکتے ہیں۔
</Caution>
...
1. خلاصہ کرنے کے لیے اسے GPT-3 پر بھیجیں۔
1. آؤٹ پٹ کو ڈیٹا بیس میں اسٹور کریں۔
...
<br />
اب آپ کے پاس خلاصہ کے سب سے اہم حصے رہ گئے ہیں!
