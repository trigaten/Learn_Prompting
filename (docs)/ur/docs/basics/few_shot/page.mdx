export const metadata = {
  sidebar_position: 70,
  title: "🟢 مثالیں دکھا رہا ہے",
};

# 🟢 مثالیں دکھا رہا ہے

<Takeaways>
  - صفر، ایک، اور چند شاٹ پرامپٹنگ سیکھیں۔ - اپنے آؤٹ پٹس کو ڈھانچے کے لیے چند
  شاٹ پرامپٹنگ کا استعمال کریں۔
</Takeaways>

اس کے باوجود ایک اور حوصلہ افزا حکمت عملی _few-shot prompting_(@logan-iv-etal-2022-cutting)(@lake2015human)[^a] ہے، جو بنیادی طور پر صرف ماڈل کو کچھ مثالیں دکھا رہی ہے[^b] (جسے "" بھی کہا جاتا ہے شاٹس") جو آپ اسے کرنا چاہتے ہیں۔ چند شاٹ پرامپٹس AI کو ان چند مثالوں (@zhao2021calibrate) سے سیکھنے کی اجازت دیتے ہیں۔
...
[^b]: ان مثالوں کے لیے تکنیکی لفظ _exemplars_ ہے۔
