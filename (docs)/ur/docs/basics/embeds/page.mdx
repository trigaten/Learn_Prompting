export const metadata = {
  sidebar_position: 40,
  title: "🟢 ایمبیڈز کا پرامپٹ کرنا سیکھیں۔",
};

# 🟢 ایمبیڈز کا پرامپٹ کرنا سیکھیں۔

<Takeaways>
  - سیکھیں پرامپٹ ایمبیڈ سیٹ اپ کریں۔ - کورس کی ویب سائٹ میں چیٹ جی پی ٹی
  پرامپٹس چلائیں۔
</Takeaways>
...
<Caution>
  کبھی بھی کسی کو اپنی API کلید مت بتائیں، کیونکہ وہ آپ کے اکاؤنٹ کو پرامپٹ سے
  چارج کر سکتے ہیں۔
</Caution>
