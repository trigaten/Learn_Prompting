export const metadata = { sidebar_position: 98, title: "🟢 LLM Settings" };
...
<Takeaways>- Understand Temperature, Top P, and Maximum Length</Takeaways>

# Introduction

We can use certain <Term term="LLM">LLM</Term>[^a] settings to control various aspects of the model, such as how 'random' it is. These settings can be adjusted to produce more creative, diverse, and interesting output. The Temperature, Top P and Max Length settings are most important, but we describe every setting that the OpenAI Playground allows you to modify.
