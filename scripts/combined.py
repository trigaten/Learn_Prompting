...
with open(output_file, 'w') as outfile, open(output_md_file, 'w') as mdfile:
    ...
    for dirpath, dirnames, filenames in os.walk(dir_path):
        ...
        for filename in filenames:
            ...
            if filename.endswith('.bib') and filename not in processed_files:
                ...
                # Parse the .bib file
                bib_database = parser.parse_string(bib_content)

                # Write the heading to the markdown file
                heading_level = '###' if dirpath == dir_path else '####'
