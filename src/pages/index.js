        ...
        <div class="text--center padding-horiz--md">
          ...
          <div className="row">
            <div className={clsx('col col--12')}>
              ...
              <a href="https://unwindai.substack.com/p/navigating-through-the-innov-ai-tion"><img src={require('@site/static/img/unwind.png').default} alt="img" height="40px" style={{ alignSelf: 'center' }}/></a>
