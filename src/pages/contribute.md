...
found a good paper, synthesize it's different techniques into short articles, and put them in the appropriate sections. The [PAL article](https://learnprompting.org/docs/advanced_applications/pal) is a good example of this. When adding papers (and other content), you should cite them. Check out [bibliography.bib](https://github.com/trigaten/Learn_Prompting/blob/main/bibliography.bib) and [bibliography.md](https://github.com/trigaten/Learn_Prompting/blob/main/docs/bibliography.md). The citation info must be put in these places. You can them use the citation in a md files by typing `(@citation_name)`. See the [CoT](https://github.com/trigaten/Learn_Prompting/blob/main/docs/intermediate/chain_of_thought.md) page for a good example of this. Citation lists will then autogenerate at the bottom of pages.
