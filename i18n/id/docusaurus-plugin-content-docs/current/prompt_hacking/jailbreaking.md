...
One-shot jailbreak awalnya berasal dari [AIWithVibes Newsletter Team](https://chatgpt-jailbreak.super.site/), di mana model menjawab prompt menggunakan logika yang ketat dan mengurangi beberapa batasan etika yang lebih ketat pula(@AI_jailbreak).
