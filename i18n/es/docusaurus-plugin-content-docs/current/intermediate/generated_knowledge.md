...
El enfoque del conocimiento generado se introdujo en realidad para una tarea completamente distinta, la de responder a preguntas difíciles. Consideremos la siguiente pregunta, a la que GPT-3 responde incorrectamente:  <iframe
...
Comencemos con el primer paso, _generación de conocimiento_. Podemos pedirle al %%LLM|LLM%% que genere información sobre Congo y Sudáfrica: <iframe
...
A continuación, usemos ese conocimiento para responder correctamente la pregunta. ¡Este es el paso de _integración de conocimiento_! <iframe
