...
[^a]: رول پرمپٹنگ کو *رول پلے*(@shanahan2023roleplay)، *رول پلے*(@li2023camel)، یا یہاں تک کہ *persona pattern*(@white2023prompt) کے نام سے بھی جانا جاتا ہے۔

[^b]: یہ *ChatGPT* کے لیے بنائے گئے تھے، لیکن یہ ممکنہ طور پر دوسرے AIs کے ساتھ کام کرتے ہیں، اور آپ انہیں اپنے پرامپٹس بنانے کے لیے بطور ترغیب بھی استعمال کر سکتے ہیں۔
