...
Спробуйте вставити завдання в демоверсію нижче: <iframe
...
```
Визначте, як кожен вибір посилює, послаблює або не впливає на аргумент.
```
щоб краще зрозуміти критерії вибору відповіді.  <iframe
...
```
Модель використовуватиме правильну формулу Баєса. <iframe
