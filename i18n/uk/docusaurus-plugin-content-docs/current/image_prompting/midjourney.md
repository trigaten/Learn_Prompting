...
[Midjourney](https://www.midjourney.com) – це генератор зображень на основі ШІ, який працює через інтерфейс бота в Discord або вебдодаток (планується також API-версія Midjourney). Процес створення зображень за допомогою Midjourney відбувається за тими самими основними принципами, що й інші ШІ генератори, включно з використанням запитів для керування процесом створення.
...
`--seed 100` встановлює довільне початкове значення, яке можна використати для повторного відтворення або перероблення зображення пізніше.
