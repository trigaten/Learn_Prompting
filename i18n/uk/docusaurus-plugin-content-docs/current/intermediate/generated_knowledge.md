...
Підхід до генерованих знань був фактично введений для зовсім іншої задачі — відповіді на складні запитання. Нижче розглянемо питання, на яке GPT-3 відповідає неправильно:  <iframe
...
Розпочнімо з першого кроку — *генерації знань*. Ми можемо попросити %%ВММ|LLМ%% згенерувати факти про Конґо та Південну Африку: <iframe
...
Далі використаймо ці знання, щоб правильно відповісти на запитання. Це *крок інтеграції* знань! <iframe
...
- Знання 1: `Kangaroos are marsupials that live in Australia.`

- Знання 2: `Kangaroos are marsupials that have 5 limbs.`

Тепер ми об’єднуємо кожне знання із запитанням, щоб створити запитання з розширеними знаннями:

- Запитання 1 із розширенням знань: `Most Kangaroos have <mask\> limbs. Kangaroos are marsupials that live in Australia.`

- Запитання 2 із розширенням знань: `Most Kangaroos have <mask\> limbs. Kangaroos are marsupials that have 5 limbs.`
