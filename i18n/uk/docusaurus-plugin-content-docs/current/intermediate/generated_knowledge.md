...
```text
Згенеруйте 4 факти про кермодського ведмедя, а потім, використовуючи цю інформацію, створіть короткий допис для блогу:
// highlight-start
...
2. Кермодський ведмідь — символ корінних народів Британської Колумбії й вважається тотемним звіром. 
...
```text
Згенеруйте 10 фактів про кермодських ведмедів:
// highlight-start
