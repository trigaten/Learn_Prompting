...
Достатньо просто надати йому приклад власних текстів. Щоб продемонструвати це, ми показали GPT-3 кілька електронних листів, написаних «доктором Родріґесом», і попросили написати новий лист у тому ж стилі новому пацієнту, пану Інуесу. <iframe
