...
이 기사는 프롬프트 엔지니어링나 AI에 전혀 경험이 없는 사람들을 위해서 만들어졌습니다. 주요 시청자는 기술자가 아닌 모두입니다. 우리는 왜 여러분이 프롬프트 엔지니어링을 공부해야 하는 지와 AI의 기초를 다룰 것입니다.
...
AI는 종종 여러분이 수많은 시간을 들여서 하는 일을 **즉시** 자동화 합니다.
위에서 언급한 다양한 예시들처럼 여러분 또한 여러분이 하고 있는 약간의 반복적인 작업을 맡길 생각을 하고 있을 수도 있습니다.
이메일 쓰기, 레포트 작성하기 또는 코드 작성하기 등이 될 수 있을 것입니다. 만약 여러분이 AI에게 그 작업을 설명할 수만 있다면,
AI는 아마 당신 대신에 전부 해버리거나 적어도 시작점은 제공할 것입니다.
...
[놀이터](https://beta.openai.com/playground), [다른 IDE들](https://learnprompting.org/docs/tooling/IDEs/intro) 혹은 간단하게 [Dyno](https://trydyno.com) 등을 이용해서 실험을 해볼 수도 있을 것입니다.

다음 기사를 읽기 전에, 프롬프트 엔지니어링에 대한 기술적 배경이 필요하지 않다는 점은 중요합니다. 대부분은 시도와 오류 그리고 실행으로부터 배울 것입니다. 
